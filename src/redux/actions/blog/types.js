...
export const GET_BLOG_LIST_CATEGORIES_SUCCESS = 'GET_BLOG_LIST_CATEGORIES_SUCCES';
...
export const GET_SEARCH_BLOG_SUCCESS = 'GET_SEARCH_BLOG_LIST_SUCCESS';
export const GET_SEARCH_BLOG_FAIL = 'GET_SEARCH_BLOG_LIST_FAIL';